...
export default function FeaturedPost() {
  return (
    <section className="mx-auto w-full max-w-310 p-6">
      <div className="relative flex flex-col md:block p-4 md:p-0 border border-[#999999] rounded-2xl bg-white shadow-xl">
        ...
        <div
          className="
            relative mx-auto bg-white mt-6.5 rounded-xl border border-[#999999] p-6
        ...
        >
          <p className="mb-4 text-[#333333] font-bold text-[10px] uppercase tracking-wider">
            DEVELOPMENT{" "}
            <span className="ml-2 text-[#666666] font-normal uppercase">
              16 March 2023
            </span>
          </p>
          ...
          <button className="text-white border border-[#7C4EE4] bg-[#7C4EE4] font-bold text-sm px-8 py-3 md:px-4 md:py-2 rounded-lg hover:bg-[#7C4EE4]/90 transition-all">
            Read More
          </button>
        </div>
      </div>
